...
<table class="table">
  <tr>
    ...
    <td><b><i>Member and Newcomer Day</i></b><br />Tutorials for Newcomers, Hackathon for Students, Technical Workgroup
	  ...
	  <br/> Venue: <em>La Cité des Sciences et de l'Industrie,</em> Porte de la Villete, Paris.
  ...
  <tr>
    ...
    <td><b><i>Main Conference Program</i></b><br />Keynotes, Plenary Presentations, Panels, Demo Theatre, Expo,
      Posters
	  <br/> Venue: <em>La Cité des Sciences et de l'Industrie,</em> Porte de la Villette, Paris.
  ...
  <tr>
	...
	<br /><a href="side-events"><b>Learn more</b></a> -- Venue: <em>INRIA Paris</em>, 48 rue Barrault, Paris.</td>
  </tr>
</table>
